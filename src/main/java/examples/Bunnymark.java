...
public class Bunnymark {
    ...
    public static void main(String[] args) {
        ...
        // you dont need to create arena
        // it will create auto arena if you omit this line, but perhaps its faster if manage our own?
        try (Arena arena = Arena.ofConfined()) {
            ...
            // Load bunny texture
            var texBunny = loadTexture(arena, "resources/wabbit_alpha.png");
